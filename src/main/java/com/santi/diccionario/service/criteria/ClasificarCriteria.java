...
/**
 * Criteria class for the {@link com.santi.diccionario.domain.Clasificar} entity. This class is used
 * in {@link com.santi.diccionario.web.rest.ClasificarResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /clasificars?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class ClasificarCriteria implements Serializable, Criteria {
    ...
    public ClasificarCriteria() {}

    public ClasificarCriteria(ClasificarCriteria other) {
    ...
    @Override
    public ClasificarCriteria copy() {
        return new ClasificarCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ClasificarCriteria that = (ClasificarCriteria) o;
        return (
