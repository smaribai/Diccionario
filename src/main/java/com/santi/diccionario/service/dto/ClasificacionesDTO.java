...
/**
 * A DTO for the {@link com.santi.diccionario.domain.Clasificaciones} entity.
 */
public class ClasificacionesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClasificacionesDTO)) {
            return false;
        }

        ClasificacionesDTO clasificacionesDTO = (ClasificacionesDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, clasificacionesDTO.id);
    }
