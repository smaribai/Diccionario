...
public class Provincia implements Serializable {
    ...
    @NotNull
    @Size(min = 3, max = 3)
    @Column(name = "codigo_provincia", length = 3, nullable = false, unique = true)
    private String codigoProvincia;

    @NotNull
    @Size(max = 30)
    @Column(name = "nombre_provincia", length = 30, nullable = false, unique = true)
    ...
    public Provincia codigoProvincia(String codigoProvincia) {
        this.setCodigoProvincia(codigoProvincia);
        return this;
    }
