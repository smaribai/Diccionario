...
import reducer, { getEntities, getEntity, reset } from './clasificaciones.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IClasificaciones, defaultValue } from 'app/shared/model/clasificaciones.model';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IClasificaciones> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASIFICACIONES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASIFICACIONES actions', async () => {
      const expectedActions = [
        {
