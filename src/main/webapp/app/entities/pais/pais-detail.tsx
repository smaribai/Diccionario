    ...
    <Row>
      <Col md="8">
        <h2 data-cy="paisDetailsHeading">
          <Translate contentKey="diccionarioApp.pais.detail.title">Pais</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="codigoPais">
              <Translate contentKey="diccionarioApp.pais.codigoPais">Codigo Pais</Translate>
            </span>
          </dt>
          <dd>{paisEntity.codigoPais}</dd>
          <dt>
            <span id="nombrePais">
              <Translate contentKey="diccionarioApp.pais.nombrePais">Nombre Pais</Translate>
            </span>
          </dt>
