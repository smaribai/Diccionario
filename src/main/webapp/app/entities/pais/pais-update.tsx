  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="diccionarioApp.pais.home.createOrEditLabel" data-cy="PaisCreateUpdateHeading">
            <Translate contentKey="diccionarioApp.pais.home.createOrEditLabel">Create or edit a Pais</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('diccionarioApp.pais.codigoPais')}
                id="pais-codigoPais"
                name="codigoPais"
                data-cy="codigoPais"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('diccionarioApp.pais.nombrePais')}
                id="pais-nombrePais"
                name="nombrePais"
                data-cy="nombrePais"
                type="text"
