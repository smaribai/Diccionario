...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASIFICAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASIFICAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASIFICAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASIFICAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASIFICAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASIFICAR actions', async () => {
      const expectedActions = [
        {
