...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADUCCION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRADUCCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRADUCCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRADUCCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRADUCCION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRADUCCION actions', async () => {
      const expectedActions = [
        {
