...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './provincia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVINCIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROVINCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVINCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVINCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVINCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVINCIA actions', async () => {
      const expectedActions = [
        {
