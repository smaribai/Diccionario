  ...
  return (
    <div>
      <h2 id="provincia-heading" data-cy="ProvinciaHeading">
        <Translate contentKey="diccionarioApp.provincia.home.title">Provincias</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="diccionarioApp.provincia.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/provincia/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="diccionarioApp.provincia.home.createLabel">Create new Provincia</Translate>
          </Link>
        </div>
      </h2>
          ...
          {provinciaList && provinciaList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="diccionarioApp.provincia.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('codigoProvincia')}>
                    <Translate contentKey="diccionarioApp.provincia.codigoProvincia">Codigo Provincia</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('nombreProvincia')}>
                    <Translate contentKey="diccionarioApp.provincia.nombreProvincia">Nombre Provincia</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              ...
              <tbody>
                {provinciaList.map((provincia, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{provincia.codigoProvincia}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="diccionarioApp.provincia.home.notFound">No Provincias found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
