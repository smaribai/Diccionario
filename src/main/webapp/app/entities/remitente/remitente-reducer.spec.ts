...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './remitente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMITENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REMITENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMITENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMITENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMITENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMITENTE actions', async () => {
      const expectedActions = [
        {
