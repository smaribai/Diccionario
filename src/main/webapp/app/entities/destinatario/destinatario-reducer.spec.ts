...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESTINATARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESTINATARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESTINATARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESTINATARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESTINATARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESTINATARIO actions', async () => {
      const expectedActions = [
        {
