    ...
    <Row>
      <Col md="8">
        <h2 data-cy="idiomaDetailsHeading">
          <Translate contentKey="diccionarioApp.idioma.detail.title">Idioma</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{idiomaEntity.id}</dd>
          <dt>
            <span id="codigo">
              <Translate contentKey="diccionarioApp.idioma.codigo">Codigo</Translate>
            </span>
          </dt>
          <dd>{idiomaEntity.codigo}</dd>
          <dt>
            <span id="nombre">
              <Translate contentKey="diccionarioApp.idioma.nombre">Nombre</Translate>
            </span>
          </dt>
        ...
        &nbsp;
        <Button tag={Link} to={`/idioma/${idiomaEntity.id}/edit`} replace color="primary">
