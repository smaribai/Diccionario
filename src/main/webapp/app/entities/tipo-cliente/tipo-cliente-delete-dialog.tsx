...
export const TipoClienteDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(tipoClienteEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="diccionarioApp.tipoCliente.delete.question">
        <Translate contentKey="diccionarioApp.tipoCliente.delete.question" interpolate={{ id: tipoClienteEntity.id }}>
